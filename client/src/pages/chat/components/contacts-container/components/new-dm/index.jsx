        ...
        <>
            <TooltipProvider>
                <Tooltip>
                    <TooltipTrigger>
                        <FaPlus
                            className="text-black text-xl font-medium hover:text-neutral-100 cursor-pointer transition-all duration-300"
                ...
                <DialogContent className="bg-[#181920] border-none text-white w-[400px] h-[400px] flex flex-col">
                                            ...
                                            >
                                                <div className="w-12 h-12 relative">
                                                    <Avatar className={`h-12 w-12 rounded-full overflow-hidden ${getColor(contact.color)}`}>
                                                        {
                                                            contact.image ? (<AvatarImage src={`${HOST}/${contact.image}`} alt="profile" className="object-cover w-full rounded-full h-full bg-black" />) :
...

                    {
                        ...
                        <div className="flex-1 md:flex flex-col justify-center items-center hidden duration-1000 transition-all ">
                            ...
                            <div className="text-opacity-80 text-white flex flex-col gap-5 items-center mt-5 lg:text-2xl text-xl transotion-all duration-300 text-center">
                                <h3 className="poppins-medium">
                                    Hi <span className="text-purple-500">!</span> Search New
                                    <span className="text-purple-500 m-1">
                                        Contact
                                    </span>
                                </h3>
                            </div>
